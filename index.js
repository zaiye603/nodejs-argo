...
const UUID = process.env.UUID || 'eecbad8f-fc9d-4f5e-a0d0-75c2a3e1c341'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.5763.eu.org';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '443';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'KI9Hqr0RFGOmvrjlYX';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
